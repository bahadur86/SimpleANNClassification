...
## streamlit app
st.title('Customer Exited Prediction')
...
if prediction_probability > 0.5:
    st.write(f"The model predicts that the customer is likely to exit with a probability of {prediction_probability:.2f}.")
else:
    st.write(f"The model predicts that the customer is likely to stay with a probability of {1 - prediction_probability:.2f}.")